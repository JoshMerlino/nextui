	...
	rippleWrapper: cva([
		...
		variants: {
			...
			color: {
				...
				"primary:pastel": "peer-checked:group-hover/checkbox:bg-primary/10 dark:peer-checked:group-hover/checkbox:bg-primary-300/10 peer-checked:group-focus-within/checkbox:bg-primary/10 dark:peer-checked:group-focus-within/checkbox:bg-primary-300/10",
				error: "group-hover/checkbox:bg-error/10 group-focus-within/checkbox:bg-error/10",
				"error:pastel": "peer-checked:group-hover/checkbox:bg-error/10 dark:peer-checked:group-hover/checkbox:bg-error-300/10 peer-checked:group-focus-within/checkbox:bg-error/10 dark:peer-checked:group-focus-within/checkbox:bg-error-300/10",
				success: "group-hover/checkbox:bg-success/10 group-focus-within/checkbox:bg-success/10",
				"success:pastel": "peer-checked:group-hover/checkbox:bg-success/10 dark:peer-checked:group-hover/checkbox:bg-success-300/10 peer-checked:group-focus-within/checkbox:bg-success/10 dark:peer-checked:group-focus-within/checkbox:bg-success-300/10",
				warning: "group-hover/checkbox:bg-warning/10 group-focus-within/checkbox:bg-warning/10",
				"warning:pastel": "peer-checked:group-hover/checkbox:bg-warning/10 dark:peer-checked:group-hover/checkbox:bg-warning-300/10 peer-checked:group-focus-within/checkbox:bg-warning/10 dark:peer-checked:group-focus-within/checkbox:bg-warning-300/10",
