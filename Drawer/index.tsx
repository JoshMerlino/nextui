...
export function Drawer({ children, className, state: [ open ], ...props }: Props & HTMLAttributes<HTMLElement>): JSX.Element {
	...
	const classes: ClassValue[] = [
		...
		// Base class
		"bg-white dark:bg-gray-800 ease-in-out w-[300px] h-full z-[10] shadow-md flex flex-col rounded-r-2xl overflow-y-auto shrink-0 group/drawer",
		
		// Custom class
		"xl:!rounded-none absolute xl:sticky top-0 z-[60] transition-transform xl:!opacity-100 xl:!translate-x-0", open ? "opacity-100 -translate-x-0" : "opacity-0 -translate-x-[300px]",
