...
export function Drawer({ children, className, state: [ open ], ...props }: Props & HTMLAttributes<HTMLElement>): JSX.Element {
	...
	const classes: ClassValue[] = [
		...
		// Base class
		"bg-white dark:bg-gray-800 ease-in-out w-[300px] h-full z-[10] shadow-md transition-[opacity] flex flex-col px-3 rounded-r-2xl overflow-y-auto shrink-0 group/drawer",
